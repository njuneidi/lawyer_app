...
import 'package:lawyer_app/src/features/tasks/presentation/task_grid.dart';
...
class _TaskScreenState extends ConsumerState<TaskScreen> {
  ...
  //   super.dispose();
  // }
//debugPrint(widget.tab.toString());
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: HomeAppBar(
          ...
          headerButton: () {
            ref.watch(taskItemNotifierProvider.notifier).item(Task(title: ''));
      ...
      body: CustomScrollView(
        ...
        slivers: [
          ...
          ResponsiveSliverCenter(
            padding: const EdgeInsets.all(Sizes.p16),
            child: TasksGrid(tabItem: widget.tabItem),
          ),
        ],
      ),
