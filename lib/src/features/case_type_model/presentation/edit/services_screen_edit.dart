...
class ServicesScreenEdit extends ConsumerStatefulWidget {
  const ServicesScreenEdit({this.entity, required this.context, super.key});
...
class MyCustomFormState extends ConsumerState<ServicesScreenEdit> {
      ...
      return () {
        if (_formKey.currentState!.validate()) {
         ...
         // databaseController.updateCaseType(widget.entity!, textfieldData);
          edit
              ? databaseController.updateService(
                  widget.entity!, textfieldData, AppRoute.services.name)
              : databaseController.addService(textfieldData, AppRoute.services.name);
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    FormBuilderTextField(
                                      ...
                                      decoration:
                                          decoration(context.loc.serviceTitle),
                                    ...
                                    FormBuilderTextField(
                                      ...
                                      decoration:
                                          decoration(context.loc.serviceDescription),
                                      onChanged: (value) => debugPrint(value),
                                      valueTransformer: (value) =>
                                          value.toString().trim(),
                                      // controller: _nameController,
