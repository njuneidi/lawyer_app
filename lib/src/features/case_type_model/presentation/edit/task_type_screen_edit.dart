...
class TaskTypeScreenEdit extends ConsumerStatefulWidget {
  const TaskTypeScreenEdit({this.entity, required this.context, super.key});
...
class MyCustomFormState extends ConsumerState<TaskTypeScreenEdit> {
      ...
      return () {
        if (_formKey.currentState!.validate()) {
         ...
         // databaseController.updateCaseType(widget.entity!, textfieldData);
          edit
              ? databaseController.updateTaskType(
                  widget.entity!, textfieldData, AppRoute.tasksType.name)
              : databaseController.addTaskType(textfieldData, AppRoute.tasksType.name);
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    FormBuilderTextField(
                                      ...
                                      decoration:
                                          decoration(context.loc.taskTypeTitle),
                                    ...
                                    FormBuilderTextField(
                                      ...
                                      decoration:
                                          decoration(context.loc.taskTypeDescription),
                                      onChanged: (value) => debugPrint(value),
                                      valueTransformer: (value) =>
                                          value.toString().trim(),
                                      // controller: _nameController,
