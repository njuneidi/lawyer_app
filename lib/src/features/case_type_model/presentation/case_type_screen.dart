...
class CaseTypeScreen extends ConsumerStatefulWidget {
  // final _scrollController = ScrollController();

  const CaseTypeScreen(
      {required this.tab,
...
class _CaseScreenState extends ConsumerState<CaseTypeScreen> {
  final _scrollController = ScrollController();
  @override
  void initState() {
    super.initState();
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        slivers: [
          ...
          ResponsiveSliverCenter(
            padding: const EdgeInsets.all(Sizes.p16),
            child: CasesTypeGrid(tabItem: widget.tabItem, controller: widget.controller,)
          ),
        ],
      ),
