...
import 'package:lawyer_app/src/features/case_type_model/presentation/task_type_grid.dart';
...
class TaskTypeScreen extends ConsumerStatefulWidget {
...
class _CaseScreenState extends ConsumerState<TaskTypeScreen> {
  final _scrollController = ScrollController();
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: HomeAppBar(
        ...
        headerButton: () {
          ref.watch(taskTypeItemNotifierProvider.notifier).taskItem(CaseTypeModel(title: ''));
      ...
      body: CustomScrollView(
        ...
        slivers: [
          ...
          ResponsiveSliverCenter(
            padding: const EdgeInsets.all(Sizes.p16),
            child: TasksTypeGrid(tabItem: widget.tabItem, controller: widget.controller,)
          ),
        ],
      ),
