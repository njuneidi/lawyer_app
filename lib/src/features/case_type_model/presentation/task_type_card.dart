...
class TaskTypeCard extends ConsumerWidget {
  TaskTypeCard({
    super.key,
    required this.item,
    this.onPressed,
  ...
  static const serviceCardKey = Key('task_type-card');
  final _scrollController = ScrollController();
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    //final ScrollController controllerOne;
    final onSaveLink = ref.watch(previousLinkNotifierProvider.notifier);
    final row = ref.watch(caseEntityNotifierProvider.notifier);
     //final row2 = ref.watch(caseEntityNotifierProvider.notifier);
...
class TaskCardHeader extends StatelessWidget {
  ...
  //final TaskTypeItemTypeItemNotifier row;
//final TaskTypeItemNotifier row;
  final CaseTypeItemNotifier row;
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          child: IconButton(
            ...
            onPressed: () {
              ...
              tabItem.linkedPage(AppRoute.editTasksType.name);
        ...
        IconButton(
            ...
            onPressed: () =>
                controller.deleteTaskType(caseItem, AppRoute.tasksType.name))
      ],
    );
  }
}
