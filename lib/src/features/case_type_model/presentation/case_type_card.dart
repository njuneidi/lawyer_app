...
class CaseTypeCard extends ConsumerWidget {
  CaseTypeCard({
    super.key,
  ...
  static const caseTypeCardKey = Key('caseType-card');
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final tab = AppRoute.casesType.name;
    ...
    return Row(
      ...
      children: [
        ...
        IconButton(
            ...
            onPressed: () =>
                controller.deleteCaseType(caseItem, AppRoute.casesType.name))
      ],
    );
  }
}
