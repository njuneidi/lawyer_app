...
import 'package:lawyer_app/src/features/case_type_model/presentation/service_card.dart';
...
class ServiceGrid extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final entityListValue = ref.watch(servicesProvider);
    // //debugPrint('-----${casesListValue.value.toString()} $filter');
    ////debugPrint(' $filter-----${casesListValue.value.toString()} $filter');
    final filteredListValue = filter == null
        ? entityListValue
        : ref.watch(filteredServiceProvider(filter));
    //debugPrint(
